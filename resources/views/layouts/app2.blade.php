...
--}}{{--                                        </a>--}}{{--
                ...
                <div
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link text-uppercase"   href="{{ url('/about') }}">About </a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-uppercase"   href="{{ url('/service')}}">Services </a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-uppercase"   href="{{ url('/cv') }}">Work Reference </a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-uppercase"   href="{{url('/members') }}">Members </a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-uppercase"   href="{{ url('/contact/create') }}">Contact </a></li>
                        @can('crud')
                            <li class="nav-item" role="presentation"><a class="nav-link text-uppercase"   href="{{ url('/admin') }}">Admin </a></li>
                        @endcan
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}">{{ __('Login') }}</a>
